...
class ABC_Problem_Image(object):
    ...
    y_dim = None
    # The value of y_obs
    y_obs = None  ###<<< S0(Dataset)
    data_obs = None ####<<< Simulated Dataset
    
    mu_dim = None # Dimension of mu (params) 
    mu_obs = None # Observed mu
    imgs_obs = None # Observed images
