...
class Base_ABC_Image(object):

    '''
    Abstract base class for ABC algorithms modified for using Images.
    '''
    ...
    def __init__(self, problem, discrepancy, hyperparams, verbose=False, save=True, **kwargs):
        ...
        self.img_obs = np.expand_dims(self.img_obs,axis=0)
        self.y_dim = self.y_obs.size
    ...
    def simulate(self):
        ...
        for i in range(self.num_sim):
            while True:
                ...
                # Collect samples & discrepancies
                self.stats[i, : , :, :] = wimg  ## It should return the images
